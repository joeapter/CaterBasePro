...
urlpatterns = [
    ...
    path('api/xpenz/estimates/<int:estimate_id>/builder/', xpenz_estimate_builder, name='xpenz_estimate_builder'),
    path('api/xpenz/estimates/<int:estimate_id>/print-html/', xpenz_estimate_print_html, name='xpenz_estimate_print_html'),
    path('api/xpenz/estimates/<int:estimate_id>/expenses/', xpenz_estimate_expenses, name='xpenz_estimate_expenses'),
    path('api/xpenz/estimates/<int:estimate_id>/planner/', xpenz_estimate_planner, name='xpenz_estimate_planner'),
    ...
    path('api/xpenz/shopping-lists/<int:shopping_list_id>/delete/', xpenz_shopping_list_delete, name='xpenz_shopping_list_delete'),
    ...
    path('api/xpenz/shopping-lists/<int:shopping_list_id>/items/<int:item_id>/update/', xpenz_shopping_list_update_item, name='xpenz_shopping_list_update_item'),
    ...
    path('api/xpenz/menu-items/', xpenz_menu_items, name='xpenz_menu_items'),
